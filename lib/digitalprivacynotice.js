 ...
 *
 *  Input to the Module is the port number to which Node.js will serve the privacy notice HTML
 *  content.
 *  If no port number is provided in input the Module assumes port 8888 and binds server to it.
 *
